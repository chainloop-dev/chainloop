...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Chainloop":
		switch fnName {
		case "AttestationInit":
			var parent Chainloop
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				panic(fmt.Errorf("%s: %w", "failed to unmarshal parent object", err))
			}
			return (*Chainloop).AttestationInit(&parent, ctx)
		case "AttestationStatus":
			...
			return (*Chainloop).AttestationStatus(&parent, ctx, attestationId)
		case "AttestationAdd":
			var parent Chainloop
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Chainloop).AttestationAdd(&parent, ctx, name, value, attestationId)
		case "AttestationPush":
			var parent Chainloop
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				panic(fmt.Errorf("%s: %w", "failed to unmarshal parent object", err))
