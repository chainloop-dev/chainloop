...
func (x *PolicyEvaluation) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (*PolicyEvaluation_Violation) Descriptor() ([]byte, []int) {
	return file_attestation_v1_crafting_state_proto_rawDescGZIP(), []int{1, 1}
}
...
var file_attestation_v1_crafting_state_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0xad, 0x04, 0x0a, 0x10, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x45, 0x76, 0x61,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	...
	0x72, 0x79, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x4a, 0x0a, 0x0a, 0x76, 0x69,
...
var file_attestation_v1_crafting_state_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_attestation_v1_crafting_state_proto_goTypes = []interface{}{
	...
	nil,                                          // 13: attestation.v1.PolicyEvaluation.LabelsEntry
	(*PolicyEvaluation_Violation)(nil),           // 14: attestation.v1.PolicyEvaluation.Violation
	(*Commit_Remote)(nil),                        // 15: attestation.v1.Commit.Remote
...
var file_attestation_v1_crafting_state_proto_depIdxs = []int32{
	16, // 0: attestation.v1.Attestation.initialized_at:type_name -> google.protobuf.Timestamp
	16, // 1: attestation.v1.Attestation.finished_at:type_name -> google.protobuf.Timestamp
	...
	17, // 6: attestation.v1.Attestation.runner_type:type_name -> workflowcontract.v1.CraftingSchema.Runner.RunnerType
	...
	13, // 9: attestation.v1.PolicyEvaluation.labels:type_name -> attestation.v1.PolicyEvaluation.LabelsEntry
	14, // 10: attestation.v1.PolicyEvaluation.violations:type_name -> attestation.v1.PolicyEvaluation.Violation
	16, // 11: attestation.v1.Commit.date:type_name -> google.protobuf.Timestamp
	15, // 12: attestation.v1.Commit.remotes:type_name -> attestation.v1.Commit.Remote
	...
	16, // 19: attestation.v1.Attestation.Material.added_at:type_name -> google.protobuf.Timestamp
