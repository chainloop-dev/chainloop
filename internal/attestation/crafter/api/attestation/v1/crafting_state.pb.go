...
type Policy struct {
	...
	Violations []*Policy_Violation `protobuf:"bytes,4,rep,name=violations,proto3" json:"violations,omitempty"`
}
...
func (x *Policy) GetMaterialName() string {
	if x != nil {
...
var file_attestation_v1_crafting_state_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf6, 0x02, 0x0a, 0x06, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	...
	0x1a, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba,
	...
	0x6e, 0x52, 0x0a, 0x76, 0x69, 0x6f, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x4f, 0x0a,
...
var file_attestation_v1_crafting_state_proto_goTypes = []interface{}{
	...
	(v1.CraftingSchema_Material_MaterialType)(0), // 18: workflowcontract.v1.CraftingSchema.Material.MaterialType
}
var file_attestation_v1_crafting_state_proto_depIdxs = []int32{
	...
	13, // 9: attestation.v1.Policy.violations:type_name -> attestation.v1.Policy.Violation
	15, // 10: attestation.v1.Commit.date:type_name -> google.protobuf.Timestamp
	14, // 11: attestation.v1.Commit.remotes:type_name -> attestation.v1.Commit.Remote
	17, // 12: attestation.v1.CraftingState.input_schema:type_name -> workflowcontract.v1.CraftingSchema
	0,  // 13: attestation.v1.CraftingState.attestation:type_name -> attestation.v1.Attestation
	7,  // 14: attestation.v1.Attestation.MaterialsEntry.value:type_name -> attestation.v1.Attestation.Material
	10, // 15: attestation.v1.Attestation.Material.string:type_name -> attestation.v1.Attestation.Material.KeyVal
	11, // 16: attestation.v1.Attestation.Material.container_image:type_name -> attestation.v1.Attestation.Material.ContainerImage
	12, // 17: attestation.v1.Attestation.Material.artifact:type_name -> attestation.v1.Attestation.Material.Artifact
	15, // 18: attestation.v1.Attestation.Material.added_at:type_name -> google.protobuf.Timestamp
	18, // 19: attestation.v1.Attestation.Material.material_type:type_name -> workflowcontract.v1.CraftingSchema.Material.MaterialType
	9,  // 20: attestation.v1.Attestation.Material.annotations:type_name -> attestation.v1.Attestation.Material.AnnotationsEntry
