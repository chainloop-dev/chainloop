...
var file_attestation_v1_crafting_state_proto_depIdxs = []int32{
	...
	1,  // 23: attestation.v1.CraftingState.attestation:type_name -> attestation.v1.Attestation
	7,  // 24: attestation.v1.WorkflowMetadata.version:type_name -> attestation.v1.ProjectVersion
	27, // 25: attestation.v1.ResourceDescriptor.digest:type_name -> attestation.v1.ResourceDescriptor.DigestEntry
	32, // 26: attestation.v1.ResourceDescriptor.annotations:type_name -> google.protobuf.Struct
	11, // 27: attestation.v1.Attestation.MaterialsEntry.value:type_name -> attestation.v1.Attestation.Material
	16, // 28: attestation.v1.Attestation.Material.string:type_name -> attestation.v1.Attestation.Material.KeyVal
	17, // 29: attestation.v1.Attestation.Material.container_image:type_name -> attestation.v1.Attestation.Material.ContainerImage
	18, // 30: attestation.v1.Attestation.Material.artifact:type_name -> attestation.v1.Attestation.Material.Artifact
	19, // 31: attestation.v1.Attestation.Material.sbom_artifact:type_name -> attestation.v1.Attestation.Material.SBOMArtifact
	28, // 32: attestation.v1.Attestation.Material.added_at:type_name -> google.protobuf.Timestamp
	30, // 33: attestation.v1.Attestation.Material.material_type:type_name -> workflowcontract.v1.CraftingSchema.Material.MaterialType
	15, // 34: attestation.v1.Attestation.Material.annotations:type_name -> attestation.v1.Attestation.Material.AnnotationsEntry
	0,  // 35: attestation.v1.Attestation.Auth.type:type_name -> attestation.v1.Attestation.Auth.AuthType
	33, // 36: attestation.v1.Attestation.Material.ContainerImage.has_latest_tag:type_name -> google.protobuf.BoolValue
	18, // 37: attestation.v1.Attestation.Material.SBOMArtifact.artifact:type_name -> attestation.v1.Attestation.Material.Artifact
	20, // 38: attestation.v1.Attestation.Material.SBOMArtifact.main_component:type_name -> attestation.v1.Attestation.Material.SBOMArtifact.MainComponent
