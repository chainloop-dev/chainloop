...
func (_m *SecretsManagerIface) PutSecretValue(ctx context.Context, params *secretsmanager.PutSecretValueInput, optFns ...func(*secretsmanager.Options)) (*secretsmanager.PutSecretValueOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
func NewSecretsManagerIface(t interface {
	mock.TestingT
	Cleanup(func())
}) *SecretsManagerIface {
