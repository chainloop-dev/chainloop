...
require (
	...
	github.com/go-git/go-git/v6 v6.0.0-alpha.4 // recommended path: https://github.com/go-git/go-git/issues/1943#issuecomment-4232656963
	...
	google.golang.org/genproto/googleapis/bytestream v0.0.0-20260523011958-0a33c5d7ca68
)
...
require (
	...
	gitlab.com/gitlab-org/security-products/analyzers/common/v3 v3.4.0 // indirect
	gitlab.com/gitlab-org/security-products/analyzers/ruleset/v3 v3.3.2 // indirect
