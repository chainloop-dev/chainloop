...
var file_attestation_v1_crafting_state_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x0e, 0x0a, 0x0b, 0x41,
	...
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0xf0, 0x07, 0x0a, 0x08, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61,
	...
	0x0c, 0xfa, 0x42, 0x09, 0x9a, 0x01, 0x06, 0x2a, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x0b, 0x61,
	...
	0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42,
	0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x86, 0x01, 0x0a,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x1a, 0x9a, 0x01, 0x0a, 0x08, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61,
	...
	0x6e, 0x74, 0x42, 0x03, 0x0a, 0x01, 0x6d, 0x1a, 0x3a, 0x0a, 0x0c, 0x45, 0x6e, 0x76, 0x56, 0x61,
	0x72, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0xaf, 0x01, 0x0a, 0x0d, 0x43, 0x72, 0x61, 0x66, 0x74, 0x69, 0x6e, 0x67,
	...
	0x72, 0x79, 0x52, 0x75, 0x6e, 0x22, 0xe1, 0x01, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c,
	...
	0x74, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65, 0x61, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x74, 0x65, 0x61, 0x6d, 0x12, 0x28, 0x0a, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f,
	0x77, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72,
	...
	0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x0e, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74,
	...
	0x61, 0x70, 0x70, 0x2f, 0x63, 0x6c, 0x69, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x74, 0x74, 0x65,
...
var file_attestation_v1_crafting_state_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_attestation_v1_crafting_state_proto_goTypes = []interface{}{
	...
	nil,                                 // 4: attestation.v1.Attestation.AnnotationsEntry
	(*Attestation_Material)(nil),        // 5: attestation.v1.Attestation.Material
	nil,                                 // 6: attestation.v1.Attestation.EnvVarsEntry
	nil,                                 // 7: attestation.v1.Attestation.Material.AnnotationsEntry
	(*Attestation_Material_KeyVal)(nil), // 8: attestation.v1.Attestation.Material.KeyVal
	(*Attestation_Material_ContainerImage)(nil),  // 9: attestation.v1.Attestation.Material.ContainerImage
	(*Attestation_Material_Artifact)(nil),        // 10: attestation.v1.Attestation.Material.Artifact
	...
	(v1.CraftingSchema_Material_MaterialType)(0), // 14: workflowcontract.v1.CraftingSchema.Material.MaterialType
}
var file_attestation_v1_crafting_state_proto_depIdxs = []int32{
	11, // 0: attestation.v1.Attestation.initialized_at:type_name -> google.protobuf.Timestamp
	11, // 1: attestation.v1.Attestation.finished_at:type_name -> google.protobuf.Timestamp
	...
	4,  // 4: attestation.v1.Attestation.annotations:type_name -> attestation.v1.Attestation.AnnotationsEntry
	6,  // 5: attestation.v1.Attestation.env_vars:type_name -> attestation.v1.Attestation.EnvVarsEntry
	12, // 6: attestation.v1.Attestation.runner_type:type_name -> workflowcontract.v1.CraftingSchema.Runner.RunnerType
	13, // 7: attestation.v1.CraftingState.input_schema:type_name -> workflowcontract.v1.CraftingSchema
	0,  // 8: attestation.v1.CraftingState.attestation:type_name -> attestation.v1.Attestation
	5,  // 9: attestation.v1.Attestation.MaterialsEntry.value:type_name -> attestation.v1.Attestation.Material
	8,  // 10: attestation.v1.Attestation.Material.string:type_name -> attestation.v1.Attestation.Material.KeyVal
	9,  // 11: attestation.v1.Attestation.Material.container_image:type_name -> attestation.v1.Attestation.Material.ContainerImage
	10, // 12: attestation.v1.Attestation.Material.artifact:type_name -> attestation.v1.Attestation.Material.Artifact
	11, // 13: attestation.v1.Attestation.Material.added_at:type_name -> google.protobuf.Timestamp
	14, // 14: attestation.v1.Attestation.Material.material_type:type_name -> workflowcontract.v1.CraftingSchema.Material.MaterialType
	7,  // 15: attestation.v1.Attestation.Material.annotations:type_name -> attestation.v1.Attestation.Material.AnnotationsEntry
...
func file_attestation_v1_crafting_state_proto_init() {
	...
	file_attestation_v1_crafting_state_proto_msgTypes[5].OneofWrappers = []interface{}{
