...
Download a plugin from a specified URL to the plugins directory
...
```
-f, --filename string   Custom filename to save the plugin as (optional)
-h, --help              help for download
-u, --url string        URL of the plugin to download (required)
```
