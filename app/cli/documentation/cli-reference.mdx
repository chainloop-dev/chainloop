...
Manage Chainloop plugins for extended functionality
...
```
chainloop plugin help [command] [flags]
```
...
### chainloop plugin info

Show detailed information about a plugin

```
chainloop plugin info [plugin-name] [flags]
```
...
### chainloop plugin list

List installed plugins and their commands

```
chainloop plugin list [flags]
```
