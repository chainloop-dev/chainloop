...
// Update provides a mock function with given fields: ctx, id, blockOnPolicyViolation, policiesAllowedHostnames, preventImplicitWorkflowCreation
func (_m *OrganizationRepo) Update(ctx context.Context, id uuid.UUID, blockOnPolicyViolation *bool, policiesAllowedHostnames []string, preventImplicitWorkflowCreation *bool) (*biz.Organization, error) {
	ret := _m.Called(ctx, id, blockOnPolicyViolation, policiesAllowedHostnames, preventImplicitWorkflowCreation)
	...
	var r0 *biz.Organization
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *bool, []string, *bool) (*biz.Organization, error)); ok {
		return rf(ctx, id, blockOnPolicyViolation, policiesAllowedHostnames, preventImplicitWorkflowCreation)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *bool, []string, *bool) *biz.Organization); ok {
		r0 = rf(ctx, id, blockOnPolicyViolation, policiesAllowedHostnames, preventImplicitWorkflowCreation)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*biz.Organization)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, *bool, []string, *bool) error); ok {
		r1 = rf(ctx, id, blockOnPolicyViolation, policiesAllowedHostnames, preventImplicitWorkflowCreation)
	} else {
		r1 = ret.Error(1)
	}
