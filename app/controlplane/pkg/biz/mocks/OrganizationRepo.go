...
// SetSuspended provides a mock function for the type OrganizationRepo
func (_mock *OrganizationRepo) SetSuspended(ctx context.Context, id uuid.UUID, suspended bool) error {
...
// OrganizationRepo_SetSuspended_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetSuspended'
type OrganizationRepo_SetSuspended_Call struct {
	*mock.Call
}
...
//   - id uuid.UUID
//   - suspended bool
func (_e *OrganizationRepo_Expecter) SetSuspended(ctx interface{}, id interface{}, suspended interface{}) *OrganizationRepo_SetSuspended_Call {
	return &OrganizationRepo_SetSuspended_Call{Call: _e.mock.On("SetSuspended", ctx, id, suspended)}
}

func (_c *OrganizationRepo_SetSuspended_Call) Run(run func(ctx context.Context, id uuid.UUID, suspended bool)) *OrganizationRepo_SetSuspended_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrganizationRepo_SetSuspended_Call) Return(err error) *OrganizationRepo_SetSuspended_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *OrganizationRepo_SetSuspended_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID, suspended bool) error) *OrganizationRepo_SetSuspended_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type OrganizationRepo
func (_mock *OrganizationRepo) Update(ctx context.Context, id uuid.UUID, opts *biz.OrganizationUpdateOpts) (*biz.Organization, error) {
	...
	var r0 *biz.Organization
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, *biz.OrganizationUpdateOpts) (*biz.Organization, error)); ok {
		return returnFunc(ctx, id, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, *biz.OrganizationUpdateOpts) *biz.Organization); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, *biz.OrganizationUpdateOpts) error); ok {
...
//   - ctx context.Context
//   - id uuid.UUID
//   - opts *biz.OrganizationUpdateOpts
func (_e *OrganizationRepo_Expecter) Update(ctx interface{}, id interface{}, opts interface{}) *OrganizationRepo_Update_Call {
	return &OrganizationRepo_Update_Call{Call: _e.mock.On("Update", ctx, id, opts)}
}

func (_c *OrganizationRepo_Update_Call) Run(run func(ctx context.Context, id uuid.UUID, opts *biz.OrganizationUpdateOpts)) *OrganizationRepo_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 *biz.OrganizationUpdateOpts
		if args[2] != nil {
			arg2 = args[2].(*biz.OrganizationUpdateOpts)
		}
		run(
			arg0,
			arg1,
...
func (_c *OrganizationRepo_Update_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID, opts *biz.OrganizationUpdateOpts) (*biz.Organization, error)) *OrganizationRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
