...
func init() {
	...
	apitokenDescIsSystem := apitokenFields[13].Descriptor()
	...
	// organizationDescEnableAiAgentCollector is the schema descriptor for enable_ai_agent_collector field.
	...
	// organizationDescBlockAttestationsOnReleasedVersions is the schema descriptor for block_attestations_on_released_versions field.
