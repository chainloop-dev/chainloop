...
func RoleValidator(r authz.Role) error {
	switch r {
	case "role:instance:admin", "role:org:owner", "role:org:admin", "role:org:viewer", "role:org:member", "role:org:contributor", "role:project:admin", "role:project:viewer", "role:group:maintainer", "role:product:admin", "role:product:viewer", "role:billing_account:owner", "role:billing_account:admin":
		return nil
	default:
...
func ResourceTypeValidator(rt authz.ResourceType) error {
	switch rt {
	case "instance", "organization", "project", "group", "product", "billing_account":
		return nil
	default:
