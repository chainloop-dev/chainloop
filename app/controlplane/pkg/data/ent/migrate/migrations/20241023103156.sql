...
ALTER TABLE "workflows" ADD COLUMN "project_id" uuid, ADD CONSTRAINT "workflows_projects_project" FOREIGN KEY ("project_id") REFERENCES "projects" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION;
