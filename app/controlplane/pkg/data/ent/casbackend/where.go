...
func UpdatedAt(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldEQ(FieldUpdatedAt, v))
}
...
func UpdatedAtEQ(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldEQ(FieldUpdatedAt, v))
}

// UpdatedAtNEQ applies the NEQ predicate on the "updated_at" field.
func UpdatedAtNEQ(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldNEQ(FieldUpdatedAt, v))
}

// UpdatedAtIn applies the In predicate on the "updated_at" field.
func UpdatedAtIn(vs ...time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldIn(FieldUpdatedAt, vs...))
}

// UpdatedAtNotIn applies the NotIn predicate on the "updated_at" field.
func UpdatedAtNotIn(vs ...time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldNotIn(FieldUpdatedAt, vs...))
}

// UpdatedAtGT applies the GT predicate on the "updated_at" field.
func UpdatedAtGT(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldGT(FieldUpdatedAt, v))
}

// UpdatedAtGTE applies the GTE predicate on the "updated_at" field.
func UpdatedAtGTE(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldGTE(FieldUpdatedAt, v))
}

// UpdatedAtLT applies the LT predicate on the "updated_at" field.
func UpdatedAtLT(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldLT(FieldUpdatedAt, v))
}

// UpdatedAtLTE applies the LTE predicate on the "updated_at" field.
func UpdatedAtLTE(v time.Time) predicate.CASBackend {
	return predicate.CASBackend(sql.FieldLTE(FieldUpdatedAt, v))
}
...
func And(predicates ...predicate.CASBackend) predicate.CASBackend {
	return predicate.CASBackend(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.CASBackend) predicate.CASBackend {
	return predicate.CASBackend(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.CASBackend) predicate.CASBackend {
	return predicate.CASBackend(sql.NotPredicates(p))
}
