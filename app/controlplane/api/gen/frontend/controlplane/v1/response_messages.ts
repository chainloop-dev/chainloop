...
export interface OrgItem {
  ...
  disableRequirementsAutoMatching: boolean;
}
...
export const WorkflowContractItem = {
  encode(message: WorkflowContractItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.latestRevisionCreatedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.latestRevisionCreatedAt), writer.uint32(66).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.latestRevisionCreatedAt = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
...
function createBaseOrgItem(): OrgItem {
  return {
    ...
    disableRequirementsAutoMatching: false,
  };
}
...
export const OrgItem = {
  encode(message: OrgItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.disableRequirementsAutoMatching === true) {
      writer.uint32(72).bool(message.disableRequirementsAutoMatching);
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<OrgItem>, I>>(object: I): OrgItem {
    ...
    message.disableRequirementsAutoMatching = object.disableRequirementsAutoMatching ?? false;
    return message;
  },
};
