...
export class ArtifactServiceClientImpl implements ArtifactService {
  ...
  GetDownloadURL(
    ...
    return this.rpc.unary(ArtifactServiceGetDownloadURLDesc, GetDownloadURLRequest.fromPartial(request), metadata);
  }
}

export const ArtifactServiceDesc = { serviceName: "controlplane.v1.ArtifactService" };

export const ArtifactServiceGetDownloadURLDesc: UnaryMethodDefinitionish = {
  methodName: "GetDownloadURL",
  service: ArtifactServiceDesc,
  requestStream: false,
