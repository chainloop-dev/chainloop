...
/**
 * Deprecated: superseded by workflow-scoped API tokens. Create was removed because its policy was
 * grantable to API tokens (privilege escalation); List and Revoke remain so that existing robot
 * accounts, which never expire, can still be inventoried and retired.
 */
