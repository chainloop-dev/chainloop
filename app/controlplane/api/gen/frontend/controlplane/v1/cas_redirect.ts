...
export interface CASRedirectService {
...
export class CASRedirectServiceClientImpl implements CASRedirectService {
  ...
  GetDownloadURL(
    ...
    return this.rpc.unary(CASRedirectServiceGetDownloadURLDesc, GetDownloadURLRequest.fromPartial(request), metadata);
  }
}

export const CASRedirectServiceDesc = { serviceName: "controlplane.v1.CASRedirectService" };

export const CASRedirectServiceGetDownloadURLDesc: UnaryMethodDefinitionish = {
  methodName: "GetDownloadURL",
  service: CASRedirectServiceDesc,
  requestStream: false,
