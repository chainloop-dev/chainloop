...
var file_controlplane_v1_response_messages_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74,
	0x5f, 0x72, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x0e, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	0x21, 0x0a, 0x0c, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x69, 0x64, 0x73, 0x18,
	0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x49,
	0x64, 0x73, 0x22, 0xc7, 0x01, 0x0a, 0x1b, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x43,
	...
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x35, 0x0a, 0x02, 0x76, 0x31, 0x18,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xdf, 0x01, 0x0a, 0x11, 0x4f, 0x72, 0x67, 0x4d, 0x65, 0x6d,
	...
	0x65, 0x6d, 0x52, 0x03, 0x6f, 0x72, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x75, 0x72, 0x72, 0x65,
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x68, 0x0a, 0x07, 0x4f, 0x72, 0x67, 0x49, 0x74,
	0x65, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	...
	0x74, 0x22, 0xe1, 0x04, 0x0a, 0x0e, 0x43, 0x41, 0x53, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64,
	...
	0x55, 0x53, 0x5f, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x2a, 0x60,
...
var file_controlplane_v1_response_messages_proto_goTypes = []interface{}{
	...
	(AllowListError)(0),                      // 1: controlplane.v1.AllowListError
	...
	nil,                                      // 12: controlplane.v1.AttestationItem.AnnotationsEntry
	...
	nil,                                      // 15: controlplane.v1.AttestationItem.Material.AnnotationsEntry
	(*CASBackendItem_Limits)(nil),            // 16: controlplane.v1.CASBackendItem.Limits
...
var file_controlplane_v1_response_messages_proto_depIdxs = []int32{
	17, // 0: controlplane.v1.WorkflowItem.created_at:type_name -> google.protobuf.Timestamp
	4,  // 1: controlplane.v1.WorkflowItem.last_run:type_name -> controlplane.v1.WorkflowRunItem
	17, // 2: controlplane.v1.WorkflowRunItem.created_at:type_name -> google.protobuf.Timestamp
	17, // 3: controlplane.v1.WorkflowRunItem.finished_at:type_name -> google.protobuf.Timestamp
	0,  // 4: controlplane.v1.WorkflowRunItem.status:type_name -> controlplane.v1.RunStatus
	3,  // 5: controlplane.v1.WorkflowRunItem.workflow:type_name -> controlplane.v1.WorkflowItem
	18, // 6: controlplane.v1.WorkflowRunItem.runner_type:type_name -> workflowcontract.v1.CraftingSchema.Runner.RunnerType
	7,  // 7: controlplane.v1.WorkflowRunItem.contract_version:type_name -> controlplane.v1.WorkflowContractVersionItem
	...
	12, // 10: controlplane.v1.AttestationItem.annotations:type_name -> controlplane.v1.AttestationItem.AnnotationsEntry
	17, // 11: controlplane.v1.WorkflowContractItem.created_at:type_name -> google.protobuf.Timestamp
	17, // 12: controlplane.v1.WorkflowContractVersionItem.created_at:type_name -> google.protobuf.Timestamp
	19, // 13: controlplane.v1.WorkflowContractVersionItem.v1:type_name -> workflowcontract.v1.CraftingSchema
	17, // 14: controlplane.v1.User.created_at:type_name -> google.protobuf.Timestamp
	10, // 15: controlplane.v1.OrgMembershipItem.org:type_name -> controlplane.v1.OrgItem
	17, // 16: controlplane.v1.OrgMembershipItem.created_at:type_name -> google.protobuf.Timestamp
	17, // 17: controlplane.v1.OrgMembershipItem.updated_at:type_name -> google.protobuf.Timestamp
	17, // 18: controlplane.v1.OrgItem.created_at:type_name -> google.protobuf.Timestamp
	17, // 19: controlplane.v1.CASBackendItem.created_at:type_name -> google.protobuf.Timestamp
	17, // 20: controlplane.v1.CASBackendItem.validated_at:type_name -> google.protobuf.Timestamp
	2,  // 21: controlplane.v1.CASBackendItem.validation_status:type_name -> controlplane.v1.CASBackendItem.ValidationStatus
	16, // 22: controlplane.v1.CASBackendItem.limits:type_name -> controlplane.v1.CASBackendItem.Limits
	15, // 23: controlplane.v1.AttestationItem.Material.annotations:type_name -> controlplane.v1.AttestationItem.Material.AnnotationsEntry
