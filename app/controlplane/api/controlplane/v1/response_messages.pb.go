...
func (WorkflowContractVersionItem_RawBody_Format) EnumDescriptor() ([]byte, []int) {
	return file_controlplane_v1_response_messages_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
type PolicyEvaluations struct {
	...
	Evaluations []*v11.PolicyEvaluation `protobuf:"bytes,1,rep,name=evaluations,proto3" json:"evaluations,omitempty"`
}
...
func (x *PolicyEvaluations) GetEvaluations() []*v11.PolicyEvaluation {
	if x != nil {
...
var file_controlplane_v1_response_messages_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x57, 0x0a, 0x11, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x42, 0x0a,
	...
	0x73, 0x22, 0xe7, 0x01, 0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x43, 0x6f,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0d, 0x77, 0x6f,
	0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0xf8, 0x03, 0x0a, 0x1b,
	...
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x1a, 0xd1, 0x01, 0x0a, 0x07, 0x52, 0x61, 0x77, 0x42, 0x6f,
	...
	0x44, 0x10, 0x02, 0x2a, 0xa6, 0x01, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	,
	...
	0x4c, 0x45, 0x5f, 0x4f, 0x52, 0x47, 0x5f, 0x4f, 0x57, 0x4e, 0x45, 0x52, 0x10, 0x03, 0x2a, 0x60,
...
var file_controlplane_v1_response_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_controlplane_v1_response_messages_proto_goTypes = []interface{}{
	...
	(*WorkflowContractItem)(nil),                    // 10: controlplane.v1.WorkflowContractItem
	(*WorkflowContractVersionItem)(nil),             // 11: controlplane.v1.WorkflowContractVersionItem
	(*User)(nil),                                    // 12: controlplane.v1.User
	(*OrgMembershipItem)(nil),                       // 13: controlplane.v1.OrgMembershipItem
	(*OrgItem)(nil),                                 // 14: controlplane.v1.OrgItem
	(*CASBackendItem)(nil),                          // 15: controlplane.v1.CASBackendItem
	nil,                                             // 16: controlplane.v1.AttestationItem.AnnotationsEntry
	nil,                                             // 17: controlplane.v1.AttestationItem.PolicyEvaluationsEntry
	(*AttestationItem_EnvVariable)(nil),             // 18: controlplane.v1.AttestationItem.EnvVariable
	(*AttestationItem_Material)(nil),                // 19: controlplane.v1.AttestationItem.Material
	nil,                                             // 20: controlplane.v1.AttestationItem.Material.AnnotationsEntry
	(*WorkflowContractVersionItem_RawBody)(nil),     // 21: controlplane.v1.WorkflowContractVersionItem.RawBody
	(*CASBackendItem_Limits)(nil),                   // 22: controlplane.v1.CASBackendItem.Limits
	(*timestamppb.Timestamp)(nil),                   // 23: google.protobuf.Timestamp
	(v1.CraftingSchema_Runner_RunnerType)(0),        // 24: workflowcontract.v1.CraftingSchema.Runner.RunnerType
	(*v11.PolicyEvaluation)(nil),                    // 25: attestation.v1.PolicyEvaluation
...
var file_controlplane_v1_response_messages_proto_depIdxs = []int32{
	23, // 0: controlplane.v1.WorkflowItem.created_at:type_name -> google.protobuf.Timestamp
	7,  // 1: controlplane.v1.WorkflowItem.last_run:type_name -> controlplane.v1.WorkflowRunItem
	23, // 2: controlplane.v1.WorkflowRunItem.created_at:type_name -> google.protobuf.Timestamp
	23, // 3: controlplane.v1.WorkflowRunItem.finished_at:type_name -> google.protobuf.Timestamp
	...
	24, // 6: controlplane.v1.WorkflowRunItem.runner_type:type_name -> workflowcontract.v1.CraftingSchema.Runner.RunnerType
	11, // 7: controlplane.v1.WorkflowRunItem.contract_version:type_name -> controlplane.v1.WorkflowContractVersionItem
	18, // 8: controlplane.v1.AttestationItem.env_vars:type_name -> controlplane.v1.AttestationItem.EnvVariable
	19, // 9: controlplane.v1.AttestationItem.materials:type_name -> controlplane.v1.AttestationItem.Material
	16, // 10: controlplane.v1.AttestationItem.annotations:type_name -> controlplane.v1.AttestationItem.AnnotationsEntry
	17, // 11: controlplane.v1.AttestationItem.policy_evaluations:type_name -> controlplane.v1.AttestationItem.PolicyEvaluationsEntry
	25, // 12: controlplane.v1.PolicyEvaluations.evaluations:type_name -> attestation.v1.PolicyEvaluation
	23, // 13: controlplane.v1.WorkflowContractItem.created_at:type_name -> google.protobuf.Timestamp
	23, // 14: controlplane.v1.WorkflowContractVersionItem.created_at:type_name -> google.protobuf.Timestamp
	26, // 15: controlplane.v1.WorkflowContractVersionItem.v1:type_name -> workflowcontract.v1.CraftingSchema
	21, // 16: controlplane.v1.WorkflowContractVersionItem.raw_contract:type_name -> controlplane.v1.WorkflowContractVersionItem.RawBody
	23, // 17: controlplane.v1.User.created_at:type_name -> google.protobuf.Timestamp
	14, // 18: controlplane.v1.OrgMembershipItem.org:type_name -> controlplane.v1.OrgItem
	12, // 19: controlplane.v1.OrgMembershipItem.user:type_name -> controlplane.v1.User
	23, // 20: controlplane.v1.OrgMembershipItem.created_at:type_name -> google.protobuf.Timestamp
	23, // 21: controlplane.v1.OrgMembershipItem.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 22: controlplane.v1.OrgMembershipItem.role:type_name -> controlplane.v1.MembershipRole
	23, // 23: controlplane.v1.OrgItem.created_at:type_name -> google.protobuf.Timestamp
	23, // 24: controlplane.v1.CASBackendItem.created_at:type_name -> google.protobuf.Timestamp
	23, // 25: controlplane.v1.CASBackendItem.validated_at:type_name -> google.protobuf.Timestamp
	5,  // 26: controlplane.v1.CASBackendItem.validation_status:type_name -> controlplane.v1.CASBackendItem.ValidationStatus
	22, // 27: controlplane.v1.CASBackendItem.limits:type_name -> controlplane.v1.CASBackendItem.Limits
	9,  // 28: controlplane.v1.AttestationItem.PolicyEvaluationsEntry.value:type_name -> controlplane.v1.PolicyEvaluations
	20, // 29: controlplane.v1.AttestationItem.Material.annotations:type_name -> controlplane.v1.AttestationItem.Material.AnnotationsEntry
	4,  // 30: controlplane.v1.WorkflowContractVersionItem.RawBody.format:type_name -> controlplane.v1.WorkflowContractVersionItem.RawBody.Format
...
func file_controlplane_v1_response_messages_proto_init() {
	...
	file_controlplane_v1_response_messages_proto_msgTypes[5].OneofWrappers = []interface{}{
