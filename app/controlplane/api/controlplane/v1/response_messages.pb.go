...
var file_controlplane_v1_response_messages_proto_goTypes = []interface{}{
	...
	(*AttestationItem_EnvVariable)(nil),      // 11: controlplane.v1.AttestationItem.EnvVariable
	(*AttestationItem_Material)(nil),         // 12: controlplane.v1.AttestationItem.Material
	(*CASBackendItem_Limits)(nil),            // 13: controlplane.v1.CASBackendItem.Limits
	(*timestamppb.Timestamp)(nil),            // 14: google.protobuf.Timestamp
	(v1.CraftingSchema_Runner_RunnerType)(0), // 15: workflowcontract.v1.CraftingSchema.Runner.RunnerType
	(*v1.CraftingSchema)(nil),                // 16: workflowcontract.v1.CraftingSchema
}
var file_controlplane_v1_response_messages_proto_depIdxs = []int32{
	14, // 0: controlplane.v1.WorkflowItem.created_at:type_name -> google.protobuf.Timestamp
	3,  // 1: controlplane.v1.WorkflowItem.last_run:type_name -> controlplane.v1.WorkflowRunItem
	14, // 2: controlplane.v1.WorkflowRunItem.created_at:type_name -> google.protobuf.Timestamp
	14, // 3: controlplane.v1.WorkflowRunItem.finished_at:type_name -> google.protobuf.Timestamp
	2,  // 4: controlplane.v1.WorkflowRunItem.workflow:type_name -> controlplane.v1.WorkflowItem
	15, // 5: controlplane.v1.WorkflowRunItem.runner_type:type_name -> workflowcontract.v1.CraftingSchema.Runner.RunnerType
	6,  // 6: controlplane.v1.WorkflowRunItem.contract_version:type_name -> controlplane.v1.WorkflowContractVersionItem
	14, // 7: controlplane.v1.AttestationItem.created_at:type_name -> google.protobuf.Timestamp
	11, // 8: controlplane.v1.AttestationItem.env_vars:type_name -> controlplane.v1.AttestationItem.EnvVariable
	12, // 9: controlplane.v1.AttestationItem.materials:type_name -> controlplane.v1.AttestationItem.Material
	14, // 10: controlplane.v1.WorkflowContractItem.created_at:type_name -> google.protobuf.Timestamp
	14, // 11: controlplane.v1.WorkflowContractVersionItem.created_at:type_name -> google.protobuf.Timestamp
	16, // 12: controlplane.v1.WorkflowContractVersionItem.v1:type_name -> workflowcontract.v1.CraftingSchema
	14, // 13: controlplane.v1.User.created_at:type_name -> google.protobuf.Timestamp
	9,  // 14: controlplane.v1.OrgMembershipItem.org:type_name -> controlplane.v1.Org
	14, // 15: controlplane.v1.OrgMembershipItem.created_at:type_name -> google.protobuf.Timestamp
	14, // 16: controlplane.v1.OrgMembershipItem.updated_at:type_name -> google.protobuf.Timestamp
	14, // 17: controlplane.v1.Org.created_at:type_name -> google.protobuf.Timestamp
	14, // 18: controlplane.v1.CASBackendItem.created_at:type_name -> google.protobuf.Timestamp
	14, // 19: controlplane.v1.CASBackendItem.validated_at:type_name -> google.protobuf.Timestamp
	1,  // 20: controlplane.v1.CASBackendItem.validation_status:type_name -> controlplane.v1.CASBackendItem.ValidationStatus
	13, // 21: controlplane.v1.CASBackendItem.limits:type_name -> controlplane.v1.CASBackendItem.Limits
