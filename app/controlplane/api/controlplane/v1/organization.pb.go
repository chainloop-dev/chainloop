...
var file_controlplane_v1_organization_proto_rawDesc = []byte{
	...
	0x72, 0x67, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xb3,
...
var file_controlplane_v1_organization_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_controlplane_v1_organization_proto_goTypes = []interface{}{
	...
	(MembershipRole)(0),                                 // 9: controlplane.v1.MembershipRole
	(*OrgItem)(nil),                                     // 10: controlplane.v1.OrgItem
}
var file_controlplane_v1_organization_proto_depIdxs = []int32{
	8,  // 0: controlplane.v1.OrganizationServiceListMembershipsResponse.result:type_name -> controlplane.v1.OrgMembershipItem
	9,  // 1: controlplane.v1.OrganizationServiceUpdateMembershipRequest.role:type_name -> controlplane.v1.MembershipRole
	8,  // 2: controlplane.v1.OrganizationServiceUpdateMembershipResponse.result:type_name -> controlplane.v1.OrgMembershipItem
	10, // 3: controlplane.v1.OrganizationServiceCreateResponse.result:type_name -> controlplane.v1.OrgItem
	6,  // 4: controlplane.v1.OrganizationService.Create:input_type -> controlplane.v1.OrganizationServiceCreateRequest
	0,  // 5: controlplane.v1.OrganizationService.ListMemberships:input_type -> controlplane.v1.OrganizationServiceListMembershipsRequest
	2,  // 6: controlplane.v1.OrganizationService.DeleteMembership:input_type -> controlplane.v1.OrganizationServiceDeleteMembershipRequest
	4,  // 7: controlplane.v1.OrganizationService.UpdateMembership:input_type -> controlplane.v1.OrganizationServiceUpdateMembershipRequest
	7,  // 8: controlplane.v1.OrganizationService.Create:output_type -> controlplane.v1.OrganizationServiceCreateResponse
	...
	3,  // 10: controlplane.v1.OrganizationService.DeleteMembership:output_type -> controlplane.v1.OrganizationServiceDeleteMembershipResponse
	5,  // 11: controlplane.v1.OrganizationService.UpdateMembership:output_type -> controlplane.v1.OrganizationServiceUpdateMembershipResponse
