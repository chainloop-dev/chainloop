...
var file_controlplane_v1_organization_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0xa6, 0x02, 0x0a, 0x20, 0x4f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x55, 0x70, 0x64, 0x61,
	...
	,
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6f, 0x0a,
	0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x31, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x8a,
...
var file_controlplane_v1_organization_proto_goTypes = []interface{}{
	...
	(MembershipRole)(0),                                 // 10: controlplane.v1.MembershipRole
	(*OffsetPaginationRequest)(nil),                     // 11: controlplane.v1.OffsetPaginationRequest
	(*OrgMembershipItem)(nil),                           // 12: controlplane.v1.OrgMembershipItem
	(*OffsetPaginationResponse)(nil),                    // 13: controlplane.v1.OffsetPaginationResponse
	(*OrgItem)(nil),                                     // 14: controlplane.v1.OrgItem
}
var file_controlplane_v1_organization_proto_depIdxs = []int32{
	10, // 0: controlplane.v1.OrganizationServiceListMembershipsRequest.role:type_name -> controlplane.v1.MembershipRole
	11, // 1: controlplane.v1.OrganizationServiceListMembershipsRequest.pagination:type_name -> controlplane.v1.OffsetPaginationRequest
	12, // 2: controlplane.v1.OrganizationServiceListMembershipsResponse.result:type_name -> controlplane.v1.OrgMembershipItem
	13, // 3: controlplane.v1.OrganizationServiceListMembershipsResponse.pagination:type_name -> controlplane.v1.OffsetPaginationResponse
	10, // 4: controlplane.v1.OrganizationServiceUpdateMembershipRequest.role:type_name -> controlplane.v1.MembershipRole
	12, // 5: controlplane.v1.OrganizationServiceUpdateMembershipResponse.result:type_name -> controlplane.v1.OrgMembershipItem
	14, // 6: controlplane.v1.OrganizationServiceCreateResponse.result:type_name -> controlplane.v1.OrgItem
	14, // 7: controlplane.v1.OrganizationServiceUpdateResponse.result:type_name -> controlplane.v1.OrgItem
	...
	2,  // 11: controlplane.v1.OrganizationService.DeleteMembership:input_type -> controlplane.v1.OrganizationServiceDeleteMembershipRequest
	4,  // 12: controlplane.v1.OrganizationService.UpdateMembership:input_type -> controlplane.v1.OrganizationServiceUpdateMembershipRequest
	7,  // 13: controlplane.v1.OrganizationService.Create:output_type -> controlplane.v1.OrganizationServiceCreateResponse
	9,  // 14: controlplane.v1.OrganizationService.Update:output_type -> controlplane.v1.OrganizationServiceUpdateResponse
	1,  // 15: controlplane.v1.OrganizationService.ListMemberships:output_type -> controlplane.v1.OrganizationServiceListMembershipsResponse
	3,  // 16: controlplane.v1.OrganizationService.DeleteMembership:output_type -> controlplane.v1.OrganizationServiceDeleteMembershipResponse
	5,  // 17: controlplane.v1.OrganizationService.UpdateMembership:output_type -> controlplane.v1.OrganizationServiceUpdateMembershipResponse
