...
// Validate checks the field values on OCIRepositoryItem with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on OCIRepositoryItem with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// OCIRepositoryItemMultiError, or nil if none found.
func (m *OCIRepositoryItem) ValidateAll() error {
	return m.validate(true)
}

func (m *OCIRepositoryItem) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, OCIRepositoryItemValidationError{
					field:  "CreatedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return OCIRepositoryItemValidationError{
				field:  "CreatedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return OCIRepositoryItemMultiError(errors)
	}

	return nil
}

// OCIRepositoryItemMultiError is an error wrapping multiple validation errors
// returned by OCIRepositoryItem.ValidateAll() if the designated constraints
// aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m OCIRepositoryItemMultiError) AllErrors() []error { return m }

// OCIRepositoryItemValidationError is the validation error returned by
// OCIRepositoryItem.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e OCIRepositoryItemValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OCIRepositoryItemValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OCIRepositoryItemValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OCIRepositoryItemValidationError) Key() bool { return e.key }
...
func (e OCIRepositoryItemValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sOCIRepositoryItem.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = OCIRepositoryItemValidationError{}
