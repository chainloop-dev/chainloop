...
func (c *cASBackendServiceClient) List(ctx context.Context, in *CASBackendServiceListRequest, opts ...grpc.CallOption) (*CASBackendServiceListResponse, error) {
	...
	err := c.cc.Invoke(ctx, CASBackendService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cASBackendServiceClient) Create(ctx context.Context, in *CASBackendServiceCreateRequest, opts ...grpc.CallOption) (*CASBackendServiceCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CASBackendService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cASBackendServiceClient) Update(ctx context.Context, in *CASBackendServiceUpdateRequest, opts ...grpc.CallOption) (*CASBackendServiceUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CASBackendService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cASBackendServiceClient) Delete(ctx context.Context, in *CASBackendServiceDeleteRequest, opts ...grpc.CallOption) (*CASBackendServiceDeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, CASBackendService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cASBackendServiceClient) Revalidate(ctx context.Context, in *CASBackendServiceRevalidateRequest, opts ...grpc.CallOption) (*CASBackendServiceRevalidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, CASBackendService_Revalidate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCASBackendServiceServer must be embedded to have
...
func (UnimplementedCASBackendServiceServer) Revalidate(context.Context, *CASBackendServiceRevalidateRequest) (*CASBackendServiceRevalidateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Revalidate not implemented")
}
func (UnimplementedCASBackendServiceServer) mustEmbedUnimplementedCASBackendServiceServer() {}
func (UnimplementedCASBackendServiceServer) testEmbeddedByValue()                           {}
...
func RegisterCASBackendServiceServer(s grpc.ServiceRegistrar, srv CASBackendServiceServer) {
	// If the following call panics, it indicates UnimplementedCASBackendServiceServer was
