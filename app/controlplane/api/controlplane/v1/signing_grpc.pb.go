...
func (c *signingServiceClient) GenerateSigningCert(ctx context.Context, in *GenerateSigningCertRequest, opts ...grpc.CallOption) (*GenerateSigningCertResponse, error) {
	...
	err := c.cc.Invoke(ctx, SigningService_GenerateSigningCert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *signingServiceClient) GetTrustedRoot(ctx context.Context, in *GetTrustedRootRequest, opts ...grpc.CallOption) (*GetTrustedRootResponse, error) {
	...
	err := c.cc.Invoke(ctx, SigningService_GetTrustedRoot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSigningServiceServer) GenerateSigningCert(context.Context, *GenerateSigningCertRequest) (*GenerateSigningCertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateSigningCert not implemented")
}
func (UnimplementedSigningServiceServer) GetTrustedRoot(context.Context, *GetTrustedRootRequest) (*GetTrustedRootResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTrustedRoot not implemented")
}
