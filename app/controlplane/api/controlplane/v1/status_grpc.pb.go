...
const (
	StatusService_Infoz_FullMethodName   = "/controlplane.v1.StatusService/Infoz"
	StatusService_Statusz_FullMethodName = "/controlplane.v1.StatusService/Statusz"
)
...
func (c *statusServiceClient) Infoz(ctx context.Context, in *InfozRequest, opts ...grpc.CallOption) (*InfozResponse, error) {
	...
	err := c.cc.Invoke(ctx, StatusService_Infoz_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusServiceClient) Statusz(ctx context.Context, in *StatuszRequest, opts ...grpc.CallOption) (*StatuszResponse, error) {
	...
	err := c.cc.Invoke(ctx, StatusService_Statusz_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStatusServiceServer) Infoz(context.Context, *InfozRequest) (*InfozResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Infoz not implemented")
}
func (UnimplementedStatusServiceServer) Statusz(context.Context, *StatuszRequest) (*StatuszResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Statusz not implemented")
}
