...
func (c *attestationServiceClient) FindOrCreateWorkflow(ctx context.Context, in *FindOrCreateWorkflowRequest, opts ...grpc.CallOption) (*FindOrCreateWorkflowResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_FindOrCreateWorkflow_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) GetContract(ctx context.Context, in *AttestationServiceGetContractRequest, opts ...grpc.CallOption) (*AttestationServiceGetContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_GetContract_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) Init(ctx context.Context, in *AttestationServiceInitRequest, opts ...grpc.CallOption) (*AttestationServiceInitResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_Init_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) Store(ctx context.Context, in *AttestationServiceStoreRequest, opts ...grpc.CallOption) (*AttestationServiceStoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_Store_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) GetUploadCreds(ctx context.Context, in *AttestationServiceGetUploadCredsRequest, opts ...grpc.CallOption) (*AttestationServiceGetUploadCredsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_GetUploadCreds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) Cancel(ctx context.Context, in *AttestationServiceCancelRequest, opts ...grpc.CallOption) (*AttestationServiceCancelResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_Cancel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) GetPolicy(ctx context.Context, in *AttestationServiceGetPolicyRequest, opts ...grpc.CallOption) (*AttestationServiceGetPolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_GetPolicy_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *attestationServiceClient) GetPolicyGroup(ctx context.Context, in *AttestationServiceGetPolicyGroupRequest, opts ...grpc.CallOption) (*AttestationServiceGetPolicyGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, AttestationService_GetPolicyGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAttestationServiceServer) FindOrCreateWorkflow(context.Context, *FindOrCreateWorkflowRequest) (*FindOrCreateWorkflowResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FindOrCreateWorkflow not implemented")
}
...
func (UnimplementedAttestationServiceServer) GetUploadCreds(context.Context, *AttestationServiceGetUploadCredsRequest) (*AttestationServiceGetUploadCredsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUploadCreds not implemented")
}
...
func (UnimplementedAttestationServiceServer) GetPolicyGroup(context.Context, *AttestationServiceGetPolicyGroupRequest) (*AttestationServiceGetPolicyGroupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPolicyGroup not implemented")
}
...
func (c *workflowRunServiceClient) List(ctx context.Context, in *WorkflowRunServiceListRequest, opts ...grpc.CallOption) (*WorkflowRunServiceListResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowRunService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowRunServiceClient) View(ctx context.Context, in *WorkflowRunServiceViewRequest, opts ...grpc.CallOption) (*WorkflowRunServiceViewResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowRunService_View_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWorkflowRunServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedWorkflowRunServiceServer) testEmbeddedByValue()                            {}
...
func RegisterWorkflowRunServiceServer(s grpc.ServiceRegistrar, srv WorkflowRunServiceServer) {
	// If the following call panics, it indicates UnimplementedWorkflowRunServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
