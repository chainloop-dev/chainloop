...
func (x *SigningCertRequest) Reset() {
	*x = SigningCertRequest{}
...
func (x *SigningCertRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SigningCertRequest) ProtoMessage() {}

func (x *SigningCertRequest) ProtoReflect() protoreflect.Message {
	mi := &file_controlplane_v1_signing_proto_msgTypes[0]
...
// Deprecated: Use SigningCertRequest.ProtoReflect.Descriptor instead.
func (*SigningCertRequest) Descriptor() ([]byte, []int) {
	return file_controlplane_v1_signing_proto_rawDescGZIP(), []int{0}
}

func (x *SigningCertRequest) GetCertificateSigningRequest() []byte {
	if x != nil {
...
func (x *SigningCertResponse) Reset() {
	*x = SigningCertResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SigningCertResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SigningCertResponse) ProtoMessage() {}

func (x *SigningCertResponse) ProtoReflect() protoreflect.Message {
	mi := &file_controlplane_v1_signing_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SigningCertResponse.ProtoReflect.Descriptor instead.
func (*SigningCertResponse) Descriptor() ([]byte, []int) {
	return file_controlplane_v1_signing_proto_rawDescGZIP(), []int{1}
}

func (x *SigningCertResponse) GetChain() *CertificateChain {
	if x != nil {
		return x.Chain
	}
	return nil
...
var file_controlplane_v1_signing_proto_rawDesc = []byte{
	...
	0x12, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x43, 0x65, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x47, 0x0a, 0x1b, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	0x74, 0x65, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x07, 0xba, 0x48, 0x04, 0x7a, 0x02, 0x10,
	0x01, 0x52, 0x19, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x53, 0x69,
	0x67, 0x6e, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4e, 0x0a, 0x13,
	...
	0x61, 0x74, 0x65, 0x73, 0x32, 0x72, 0x0a, 0x0e, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x60, 0x0a, 0x13, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x43, 0x65, 0x72, 0x74, 0x12, 0x23, 0x2e,
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x43, 0x65, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x24, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x43, 0x65, 0x72, 0x74,
...
var file_controlplane_v1_signing_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_controlplane_v1_signing_proto_goTypes = []interface{}{
	(*SigningCertRequest)(nil),  // 0: controlplane.v1.SigningCertRequest
	(*SigningCertResponse)(nil), // 1: controlplane.v1.SigningCertResponse
	(*CertificateChain)(nil),    // 2: controlplane.v1.CertificateChain
}
var file_controlplane_v1_signing_proto_depIdxs = []int32{
	2, // 0: controlplane.v1.SigningCertResponse.chain:type_name -> controlplane.v1.CertificateChain
	0, // 1: controlplane.v1.SigningService.GenerateSigningCert:input_type -> controlplane.v1.SigningCertRequest
	1, // 2: controlplane.v1.SigningService.GenerateSigningCert:output_type -> controlplane.v1.SigningCertResponse
...
func file_controlplane_v1_signing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_controlplane_v1_signing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SigningCertRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_controlplane_v1_signing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SigningCertResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
