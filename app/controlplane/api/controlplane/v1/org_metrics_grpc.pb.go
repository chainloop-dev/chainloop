...
func (c *orgMetricsServiceClient) Totals(ctx context.Context, in *OrgMetricsServiceTotalsRequest, opts ...grpc.CallOption) (*OrgMetricsServiceTotalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrgMetricsService_Totals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgMetricsServiceClient) TopWorkflowsByRunsCount(ctx context.Context, in *TopWorkflowsByRunsCountRequest, opts ...grpc.CallOption) (*TopWorkflowsByRunsCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrgMetricsService_TopWorkflowsByRunsCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orgMetricsServiceClient) DailyRunsCount(ctx context.Context, in *DailyRunsCountRequest, opts ...grpc.CallOption) (*DailyRunsCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrgMetricsService_DailyRunsCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOrgMetricsServiceServer must be embedded to have
...
func (UnimplementedOrgMetricsServiceServer) TopWorkflowsByRunsCount(context.Context, *TopWorkflowsByRunsCountRequest) (*TopWorkflowsByRunsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TopWorkflowsByRunsCount not implemented")
}
func (UnimplementedOrgMetricsServiceServer) DailyRunsCount(context.Context, *DailyRunsCountRequest) (*DailyRunsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DailyRunsCount not implemented")
}
func (UnimplementedOrgMetricsServiceServer) mustEmbedUnimplementedOrgMetricsServiceServer() {}
func (UnimplementedOrgMetricsServiceServer) testEmbeddedByValue()                           {}
...
func RegisterOrgMetricsServiceServer(s grpc.ServiceRegistrar, srv OrgMetricsServiceServer) {
	// If the following call panics, it indicates UnimplementedOrgMetricsServiceServer was
...
func _OrgMetricsService_Totals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrgMetricsService_Totals_FullMethodName,
	}
...
func _OrgMetricsService_TopWorkflowsByRunsCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrgMetricsService_TopWorkflowsByRunsCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
