...
type APITokenServiceUpdateLastUsedRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *APITokenServiceUpdateLastUsedRequest) Reset() {
	*x = APITokenServiceUpdateLastUsedRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *APITokenServiceUpdateLastUsedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APITokenServiceUpdateLastUsedRequest) ProtoMessage() {}

func (x *APITokenServiceUpdateLastUsedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_controlplane_v1_api_token_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use APITokenServiceUpdateLastUsedRequest.ProtoReflect.Descriptor instead.
func (*APITokenServiceUpdateLastUsedRequest) Descriptor() ([]byte, []int) {
	return file_controlplane_v1_api_token_proto_rawDescGZIP(), []int{6}
}

func (x *APITokenServiceUpdateLastUsedRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type APITokenServiceUpdateLastUsedResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *APITokenServiceUpdateLastUsedResponse) Reset() {
	*x = APITokenServiceUpdateLastUsedResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *APITokenServiceUpdateLastUsedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APITokenServiceUpdateLastUsedResponse) ProtoMessage() {}

func (x *APITokenServiceUpdateLastUsedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_controlplane_v1_api_token_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use APITokenServiceUpdateLastUsedResponse.ProtoReflect.Descriptor instead.
func (*APITokenServiceUpdateLastUsedResponse) Descriptor() ([]byte, []int) {
	return file_controlplane_v1_api_token_proto_rawDescGZIP(), []int{7}
}

func (x *APITokenServiceUpdateLastUsedResponse) GetItem() *APITokenItem {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *APITokenServiceCreateResponse_APITokenFull) Reset() {
	*x = APITokenServiceCreateResponse_APITokenFull{}
	if protoimpl.UnsafeEnabled {
		mi := &file_controlplane_v1_api_token_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_controlplane_v1_api_token_proto_rawDesc = []byte{
	...
	0x22, 0x40, 0x0a, 0x24, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x73, 0x74, 0x55, 0x73, 0x65,
	...
	0x69, 0x64, 0x22, 0x5a, 0x0a, 0x25, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x73, 0x74, 0x55,
	0x73, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x04, 0x69,
	0x74, 0x65, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x32, 0xc7,
	0x03, 0x0a, 0x0f, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x63, 0x6f,
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50,
	0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x43, 0x72, 0x65,
	...
	0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65,
	...
	0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x67,
	0x0a, 0x06, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x12, 0x2d, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	...
	0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b,
	...
	0x65, 0x4c, 0x61, 0x73, 0x74, 0x55, 0x73, 0x65, 0x64, 0x12, 0x35, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x4c, 0x61, 0x73, 0x74, 0x55, 0x73, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x36, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x73, 0x74, 0x55, 0x73, 0x65, 0x64,
...
var file_controlplane_v1_api_token_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_controlplane_v1_api_token_proto_goTypes = []interface{}{
	...
	(*APITokenServiceUpdateLastUsedRequest)(nil),       // 6: controlplane.v1.APITokenServiceUpdateLastUsedRequest
	(*APITokenServiceUpdateLastUsedResponse)(nil),      // 7: controlplane.v1.APITokenServiceUpdateLastUsedResponse
...
var file_controlplane_v1_api_token_proto_depIdxs = []int32{
	9,  // 0: controlplane.v1.APITokenServiceCreateRequest.expires_in:type_name -> google.protobuf.Duration
	8,  // 1: controlplane.v1.APITokenServiceCreateResponse.result:type_name -> controlplane.v1.APITokenServiceCreateResponse.APITokenFull
	10, // 2: controlplane.v1.APITokenServiceListResponse.result:type_name -> controlplane.v1.APITokenItem
	10, // 3: controlplane.v1.APITokenServiceUpdateLastUsedResponse.item:type_name -> controlplane.v1.APITokenItem
	10, // 4: controlplane.v1.APITokenServiceCreateResponse.APITokenFull.item:type_name -> controlplane.v1.APITokenItem
	0,  // 5: controlplane.v1.APITokenService.Create:input_type -> controlplane.v1.APITokenServiceCreateRequest
	4,  // 6: controlplane.v1.APITokenService.List:input_type -> controlplane.v1.APITokenServiceListRequest
	2,  // 7: controlplane.v1.APITokenService.Revoke:input_type -> controlplane.v1.APITokenServiceRevokeRequest
	6,  // 8: controlplane.v1.APITokenService.UpdateLastUsed:input_type -> controlplane.v1.APITokenServiceUpdateLastUsedRequest
	1,  // 9: controlplane.v1.APITokenService.Create:output_type -> controlplane.v1.APITokenServiceCreateResponse
	5,  // 10: controlplane.v1.APITokenService.List:output_type -> controlplane.v1.APITokenServiceListResponse
	3,  // 11: controlplane.v1.APITokenService.Revoke:output_type -> controlplane.v1.APITokenServiceRevokeResponse
	7,  // 12: controlplane.v1.APITokenService.UpdateLastUsed:output_type -> controlplane.v1.APITokenServiceUpdateLastUsedResponse
...
func file_controlplane_v1_api_token_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_controlplane_v1_api_token_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*APITokenServiceUpdateLastUsedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_controlplane_v1_api_token_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*APITokenServiceUpdateLastUsedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_controlplane_v1_api_token_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
