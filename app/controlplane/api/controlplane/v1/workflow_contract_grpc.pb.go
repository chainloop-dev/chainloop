...
func (c *workflowContractServiceClient) List(ctx context.Context, in *WorkflowContractServiceListRequest, opts ...grpc.CallOption) (*WorkflowContractServiceListResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowContractServiceClient) Create(ctx context.Context, in *WorkflowContractServiceCreateRequest, opts ...grpc.CallOption) (*WorkflowContractServiceCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowContractServiceClient) Update(ctx context.Context, in *WorkflowContractServiceUpdateRequest, opts ...grpc.CallOption) (*WorkflowContractServiceUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowContractServiceClient) Describe(ctx context.Context, in *WorkflowContractServiceDescribeRequest, opts ...grpc.CallOption) (*WorkflowContractServiceDescribeResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_Describe_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowContractServiceClient) Delete(ctx context.Context, in *WorkflowContractServiceDeleteRequest, opts ...grpc.CallOption) (*WorkflowContractServiceDeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowContractServiceClient) Apply(ctx context.Context, in *WorkflowContractServiceApplyRequest, opts ...grpc.CallOption) (*WorkflowContractServiceApplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowContractService_Apply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWorkflowContractServiceServer must be embedded to have
...
func (UnimplementedWorkflowContractServiceServer) testEmbeddedByValue() {}
...
func RegisterWorkflowContractServiceServer(s grpc.ServiceRegistrar, srv WorkflowContractServiceServer) {
	// If the following call panics, it indicates UnimplementedWorkflowContractServiceServer was
