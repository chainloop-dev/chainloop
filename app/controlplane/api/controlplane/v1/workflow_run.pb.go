...
var file_controlplane_v1_workflow_run_proto_rawDesc = []byte{
	...
	0x22, 0xa4, 0x01, 0x0a, 0x28, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xde, 0x04, 0x0a, 0x12, 0x41, 0x74, 0x74, 0x65,
...
var file_controlplane_v1_workflow_run_proto_depIdxs = []int32{
	...
	1,  // 13: controlplane.v1.AttestationService.GetContract:input_type -> controlplane.v1.AttestationServiceGetContractRequest
	3,  // 14: controlplane.v1.AttestationService.Init:input_type -> controlplane.v1.AttestationServiceInitRequest
	5,  // 15: controlplane.v1.AttestationService.Store:input_type -> controlplane.v1.AttestationServiceStoreRequest
	13, // 16: controlplane.v1.AttestationService.GetUploadCreds:input_type -> controlplane.v1.AttestationServiceGetUploadCredsRequest
	7,  // 17: controlplane.v1.AttestationService.Cancel:input_type -> controlplane.v1.AttestationServiceCancelRequest
	9,  // 18: controlplane.v1.WorkflowRunService.List:input_type -> controlplane.v1.WorkflowRunServiceListRequest
	11, // 19: controlplane.v1.WorkflowRunService.View:input_type -> controlplane.v1.WorkflowRunServiceViewRequest
	2,  // 20: controlplane.v1.AttestationService.GetContract:output_type -> controlplane.v1.AttestationServiceGetContractResponse
	4,  // 21: controlplane.v1.AttestationService.Init:output_type -> controlplane.v1.AttestationServiceInitResponse
	6,  // 22: controlplane.v1.AttestationService.Store:output_type -> controlplane.v1.AttestationServiceStoreResponse
	14, // 23: controlplane.v1.AttestationService.GetUploadCreds:output_type -> controlplane.v1.AttestationServiceGetUploadCredsResponse
	8,  // 24: controlplane.v1.AttestationService.Cancel:output_type -> controlplane.v1.AttestationServiceCancelResponse
	10, // 25: controlplane.v1.WorkflowRunService.List:output_type -> controlplane.v1.WorkflowRunServiceListResponse
	12, // 26: controlplane.v1.WorkflowRunService.View:output_type -> controlplane.v1.WorkflowRunServiceViewResponse
