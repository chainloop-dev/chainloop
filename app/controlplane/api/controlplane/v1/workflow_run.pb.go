...
var file_controlplane_v1_workflow_run_proto_rawDesc = []byte{
	...
	0x77, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x22, 0x21, 0x0a, 0x1f, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb2, 0x02, 0x0a, 0x1f, 0x41, 0x74,
	...
	0x0d, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x12, 0x60,
	...
	0x74, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x42, 0x08, 0xfa,
	0x42, 0x05, 0x82, 0x01, 0x02, 0x20, 0x00, 0x52, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	...
	0x73, 0x65, 0x22, 0x84, 0x01, 0x0a, 0x1d, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52,
	...
	0x6c, 0x6f, 0x77, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x9f, 0x01, 0x0a, 0x1e, 0x57, 0x6f,
	...
	,
...
var file_controlplane_v1_workflow_run_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_controlplane_v1_workflow_run_proto_goTypes = []interface{}{
	...
	(*WorkflowRunServiceViewResponse_Result)(nil),           // 17: controlplane.v1.WorkflowRunServiceViewResponse.Result
	(*AttestationServiceGetUploadCredsResponse_Result)(nil), // 18: controlplane.v1.AttestationServiceGetUploadCredsResponse.Result
	(*PaginationRequest)(nil),                               // 19: controlplane.v1.PaginationRequest
	(*WorkflowRunItem)(nil),                                 // 20: controlplane.v1.WorkflowRunItem
	(*PaginationResponse)(nil),                              // 21: controlplane.v1.PaginationResponse
	(*WorkflowItem)(nil),                                    // 22: controlplane.v1.WorkflowItem
	(*WorkflowContractVersionItem)(nil),                     // 23: controlplane.v1.WorkflowContractVersionItem
	(*AttestationItem)(nil),                                 // 24: controlplane.v1.AttestationItem
...
var file_controlplane_v1_workflow_run_proto_depIdxs = []int32{
	...
	0,  // 2: controlplane.v1.AttestationServiceCancelRequest.trigger:type_name -> controlplane.v1.AttestationServiceCancelRequest.TriggerType
	19, // 3: controlplane.v1.WorkflowRunServiceListRequest.pagination:type_name -> controlplane.v1.PaginationRequest
	20, // 4: controlplane.v1.WorkflowRunServiceListResponse.result:type_name -> controlplane.v1.WorkflowRunItem
	21, // 5: controlplane.v1.WorkflowRunServiceListResponse.pagination:type_name -> controlplane.v1.PaginationResponse
	17, // 6: controlplane.v1.WorkflowRunServiceViewResponse.result:type_name -> controlplane.v1.WorkflowRunServiceViewResponse.Result
	18, // 7: controlplane.v1.AttestationServiceGetUploadCredsResponse.result:type_name -> controlplane.v1.AttestationServiceGetUploadCredsResponse.Result
	22, // 8: controlplane.v1.AttestationServiceGetContractResponse.Result.workflow:type_name -> controlplane.v1.WorkflowItem
	23, // 9: controlplane.v1.AttestationServiceGetContractResponse.Result.contract:type_name -> controlplane.v1.WorkflowContractVersionItem
	20, // 10: controlplane.v1.AttestationServiceInitResponse.Result.workflow_run:type_name -> controlplane.v1.WorkflowRunItem
	20, // 11: controlplane.v1.WorkflowRunServiceViewResponse.Result.workflow_run:type_name -> controlplane.v1.WorkflowRunItem
	24, // 12: controlplane.v1.WorkflowRunServiceViewResponse.Result.attestation:type_name -> controlplane.v1.AttestationItem
	25, // 13: controlplane.v1.AttestationServiceGetUploadCredsResponse.Result.backend:type_name -> controlplane.v1.CASBackendItem
	1,  // 14: controlplane.v1.AttestationService.GetContract:input_type -> controlplane.v1.AttestationServiceGetContractRequest
	3,  // 15: controlplane.v1.AttestationService.Init:input_type -> controlplane.v1.AttestationServiceInitRequest
	5,  // 16: controlplane.v1.AttestationService.Store:input_type -> controlplane.v1.AttestationServiceStoreRequest
	13, // 17: controlplane.v1.AttestationService.GetUploadCreds:input_type -> controlplane.v1.AttestationServiceGetUploadCredsRequest
	7,  // 18: controlplane.v1.AttestationService.Cancel:input_type -> controlplane.v1.AttestationServiceCancelRequest
	9,  // 19: controlplane.v1.WorkflowRunService.List:input_type -> controlplane.v1.WorkflowRunServiceListRequest
	11, // 20: controlplane.v1.WorkflowRunService.View:input_type -> controlplane.v1.WorkflowRunServiceViewRequest
	2,  // 21: controlplane.v1.AttestationService.GetContract:output_type -> controlplane.v1.AttestationServiceGetContractResponse
	4,  // 22: controlplane.v1.AttestationService.Init:output_type -> controlplane.v1.AttestationServiceInitResponse
	6,  // 23: controlplane.v1.AttestationService.Store:output_type -> controlplane.v1.AttestationServiceStoreResponse
	14, // 24: controlplane.v1.AttestationService.GetUploadCreds:output_type -> controlplane.v1.AttestationServiceGetUploadCredsResponse
	8,  // 25: controlplane.v1.AttestationService.Cancel:output_type -> controlplane.v1.AttestationServiceCancelResponse
	10, // 26: controlplane.v1.WorkflowRunService.List:output_type -> controlplane.v1.WorkflowRunServiceListResponse
	12, // 27: controlplane.v1.WorkflowRunService.View:output_type -> controlplane.v1.WorkflowRunServiceViewResponse
