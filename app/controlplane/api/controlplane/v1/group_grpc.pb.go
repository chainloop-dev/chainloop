...
func (c *groupServiceClient) UpdateMemberMaintainerStatus(ctx context.Context, in *GroupServiceUpdateMemberMaintainerStatusRequest, opts ...grpc.CallOption) (*GroupServiceUpdateMemberMaintainerStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_UpdateMemberMaintainerStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupServiceClient) ListPendingInvitations(ctx context.Context, in *GroupServiceListPendingInvitationsRequest, opts ...grpc.CallOption) (*GroupServiceListPendingInvitationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_ListPendingInvitations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *groupServiceClient) ListProjects(ctx context.Context, in *GroupServiceListProjectsRequest, opts ...grpc.CallOption) (*GroupServiceListProjectsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GroupService_ListProjects_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGroupServiceServer) UpdateMemberMaintainerStatus(context.Context, *GroupServiceUpdateMemberMaintainerStatusRequest) (*GroupServiceUpdateMemberMaintainerStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMemberMaintainerStatus not implemented")
}
