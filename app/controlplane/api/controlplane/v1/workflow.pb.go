...
var file_controlplane_v1_workflow_proto_rawDesc = []byte{
	...
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xc6, 0x02, 0x0a,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x61, 0x0a, 0x04, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x2b, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x70, 0x6c, 0x61, 0x6e, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x67, 0x0a, 0x06,
	...
	0x76, 0x2f, 0x62, 0x65, 0x64, 0x72, 0x6f, 0x63, 0x6b, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x63, 0x6f,
...
var file_controlplane_v1_workflow_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_controlplane_v1_workflow_proto_depIdxs = []int32{
	6, // 0: controlplane.v1.WorkflowServiceCreateResponse.result:type_name -> controlplane.v1.WorkflowItem
	6, // 1: controlplane.v1.WorkflowServiceListResponse.result:type_name -> controlplane.v1.WorkflowItem
	0, // 2: controlplane.v1.WorkflowService.Create:input_type -> controlplane.v1.WorkflowServiceCreateRequest
	4, // 3: controlplane.v1.WorkflowService.List:input_type -> controlplane.v1.WorkflowServiceListRequest
	2, // 4: controlplane.v1.WorkflowService.Delete:input_type -> controlplane.v1.WorkflowServiceDeleteRequest
	1, // 5: controlplane.v1.WorkflowService.Create:output_type -> controlplane.v1.WorkflowServiceCreateResponse
	5, // 6: controlplane.v1.WorkflowService.List:output_type -> controlplane.v1.WorkflowServiceListResponse
	3, // 7: controlplane.v1.WorkflowService.Delete:output_type -> controlplane.v1.WorkflowServiceDeleteResponse
