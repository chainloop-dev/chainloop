...
-- Create "referrer_organizations" table
CREATE TABLE "referrer_organizations" ("referrer_id" uuid NOT NULL, "organization_id" uuid NOT NULL, PRIMARY KEY ("referrer_id", "organization_id"), CONSTRAINT "referrer_organizations_organization_id" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "referrer_organizations_referrer_id" FOREIGN KEY ("referrer_id") REFERENCES "referrers" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
