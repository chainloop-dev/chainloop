...
const (
	// Label holds the string label denoting the orginvite type in the database.
	Label = "org_invite"
	...
	EdgeSender = "sender"
	// Table holds the table name of the orginvite in the database.
	Table = "org_invites"
	// OrganizationTable is the table that holds the organization relation/edge.
	OrganizationTable = "org_invites"
...
// Columns holds all SQL columns for orginvite fields.
var Columns = []string{
	FieldID,
	FieldReceiverEmail,
	FieldStatus,
...
const DefaultStatus biz.OrgInviteStatus = "pending"
...
// OrderOption defines the ordering options for the OrgInvite queries.
