...
type IntegrationsService struct {
	...
	*service
	...
	integrations  integrations.Initialized
}

func NewIntegrationsService(uc *biz.IntegrationUseCase, wuc *biz.WorkflowUseCase, integrations integrations.Initialized, opts ...NewOpt) *IntegrationsService {
