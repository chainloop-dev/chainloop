...
type Bootstrap struct {
	...
	// CAS Server endpoint
	CasServer *Server_GRPC `protobuf:"bytes,6,opt,name=cas_server,json=casServer,proto3" json:"cas_server,omitempty"`
}
...
func (x *Bootstrap) GetCasServer() *Server_GRPC {
	if x != nil {
		return x.CasServer
	}
	return nil
...
var file_conf_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97, 0x03, 0x0a,
	...
	0x12, 0x2b, 0x0a, 0x0a, 0x63, 0x61, 0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x47, 0x52,
	0x50, 0x43, 0x52, 0x09, 0x63, 0x61, 0x73, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x1a, 0x86, 0x01,
	0x0a, 0x0d, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12,
	0x37, 0x0a, 0x06, 0x73, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1f, 0x2e, 0x42, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x2e, 0x4f, 0x62, 0x73, 0x65,
	...
	0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0xf9, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x1a, 0x8e, 0x01, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12,
...
var file_conf_proto_depIdxs = []int32{
	...
	8,  // 5: Bootstrap.cas_server:type_name -> Server.GRPC
	...
	11, // 11: Credentials.aws_secret_manager:type_name -> Credentials.AWSSecretManager
	12, // 12: Credentials.vault:type_name -> Credentials.Vault
	6,  // 13: Bootstrap.Observability.sentry:type_name -> Bootstrap.Observability.Sentry
	14, // 14: Server.HTTP.timeout:type_name -> google.protobuf.Duration
	14, // 15: Server.GRPC.timeout:type_name -> google.protobuf.Duration
	13, // 16: Credentials.AWSSecretManager.creds:type_name -> Credentials.AWSSecretManager.Creds
