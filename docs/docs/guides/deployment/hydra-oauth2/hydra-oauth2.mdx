---
title: Use Ory Hydra as OAuth2 provider
---

A requirement to run your own Chainloop instance, is to have a way of authenticate users. One of the most common ways to do this is by using OAuth2.
Ory Hydra is a popular OAuth2 provider that can be used to authenticate users in your Chainloop instance once connected to an external OIDC provider.
...
- Access to your OICD provider configuration
...
CLIENT SECRET   V.Erxy5_f5zYvBHXi4fZWrB6tw
