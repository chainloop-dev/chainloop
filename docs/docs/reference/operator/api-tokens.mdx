...
└──────────────────────────────────────┴─────────────────┴─────────┴─────────────────────┴────────┴─────────────────┘
```
The flag `--skip-robot-account-create` prevents the creation of a robot account that will be of no use. Once the workflow is created, the attestation process remains pretty much the same:
```bash
