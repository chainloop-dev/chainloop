...
- Generic Artifact Types: they represent software artifacts.
- Generic Evidence Types (custom materials that don't fit in other categories, for instance approval reports in json format, etc.)
